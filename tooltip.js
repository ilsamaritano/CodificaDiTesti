$(document).on('mouseover', 'abbr', function(e) {   // Nomino la funzione per gestire il target corrente
            ...
            if(typeof attr == 'undefined' || attr == false) {   // Controllo se il "title" non esiste già...se non esiste...
